...
public class TelephoneUtil {
    ...
    public static TeleInfo getQualcommTeleInfo(Context context) {
        ...
        try {
            ...
            Object sim = context.getSystemService(Context.CAMERA_SERVICE);
            int simId_1 = 0;
            int simId_2 = 1;
